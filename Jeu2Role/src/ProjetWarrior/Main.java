...
public class Main {
    public static void main(String[] args) {
            ...
            while(pasRepondu) {
                System.out.println("Bienvenue étranger! Tu te sent l'âme d'un magicien ou d'un guerrier ?");
                ...
                if (choice.equals("magicien")) {
                    ...
                    System.out.println("Me prend pas pour un jambon!... Es-tu un guerrier ou un magicien? : ");
                }
            }
    }
}
